...
| Public/private card boundary        | Unresolved                                 | Anonymous cards policy permits all rows and callers use broad selects.                             | Define a narrow public projection and RLS/API boundary in Phases 01-02.                                 |
| Client-controlled `plan_tier`       | Unresolved, critical                       | Dashboard/editor/Pro UI can send entitlement fields in browser updates.                            | Remove client authority in Phases 02, 06, and 08.                                                       |
...
| Deactivated cards still render      | Unresolved                                 | Admin writes `is_active`, while public TanStack and legacy lookups do not consistently enforce it. | Implement active-state semantics in Phase 01.                                                           |
| Error conflation                    | Unresolved                                 | Supabase failures can become “Card not found.”                                                     | Separate 404, inactive, and 5xx paths in Phase 01.                                                      |
