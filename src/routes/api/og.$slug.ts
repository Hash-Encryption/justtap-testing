...
<svg width="1200" height="630" viewBox="0 0 1200 630" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <!-- Main Card Container -->
  <rect x="80" y="80" width="1040" height="470" rx="36" fill="#1e293b" opacity="0.75" stroke="${accent}44" stroke-width="2" filter="url(#shadow)"/>
    ...
    ${
      card.avatar_url
        ...
        : `<circle cx="240" cy="315" r="130" fill="${accent}" />
           <text x="240" y="350" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-size="110" font-weight="bold" fill="${onAccent}" text-anchor="middle">${firstLetter}</text>`
    }
  </g>
  ...
  <g transform="translate(430, 0)">
    <!-- Full Name -->
    <text x="0" y="270" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-size="56" font-weight="800" fill="#ffffff">${name}</text>

    <!-- Job Title -->
    ${
      title
        ? `<text x="0" y="330" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-size="32" font-weight="600" fill="${accent}">${title}</text>`
        : ""
    }
    ...
    ${
      company
        ? `<text x="0" y="${title ? "380" : "330"}" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-size="28" font-weight="500" fill="#94a3b8">${company}</text>`
        : ""
    }
    ...
    <g transform="translate(0, 430)">
      ...
      <text x="170" y="35" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-size="20" font-weight="700" fill="${onAccent}" text-anchor="middle">📇 TAP TO SAVE CONTACT</text>
    </g>
  </g>

  <!-- Watermark Logo -->
  <g transform="translate(920, 480)">
    <text x="0" y="30" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-size="24" font-weight="800" fill="#ffffff" opacity="0.6">JustTap<tspan fill="${accent}">.</tspan></text>
  </g>
</svg>
`;
