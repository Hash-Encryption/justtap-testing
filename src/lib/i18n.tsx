...
const translations = {
  en: {
    ...
    videoIntroPlaceholder: "https://www.youtube.com/watch?v=... or YouTube Shorts / Loom / Vimeo link",
    videoIntroSupportHint: "Supports YouTube Shorts, YouTube Watch, Loom, Vimeo, and Google Drive video URLs.",
    ...
    bookingDesc: "Link your Calendly, SavvyCal, or TidyCal URL so visitors can book meetings instantly.",
    bookingPlaceholder: "https://calendly.com/your-name/30min",
    customCtaTitle: "Custom Call-To-Action (CTA) Button",
    customCtaDesc: 'Add a high-priority action button (e.g. "Pay via Stripe", "View Portfolio", "Get Directions").',
  ...
  ar: {
    ...
    landingCard2Desc:
      "دعم كامل لاتجاه RTL واللغة العربية للاسم، المسمى الوظيفي والنبذة التعريفية.",
    ...
    qrHubSubtitle: "تصدير رموز QR عالية الدقة، بطاقات vCard دون إنترنت، خلفيات شاشة، وبطاقات Apple Wallet.",
    ...
    bookingDesc: "اربط حسابك في Calendly أو SavvyCal أو TidyCal لتمكين الزوار من حجز المواعيد فوراً.",
    bookingPlaceholder: "https://calendly.com/your-name/30min",
    customCtaTitle: "زر إجراء مخصص (CTA)",
    customCtaDesc: 'أضف زر إجراء رئيسي (مثل "الدفع الإلكتروني"، "معرض الأعمال"، "الموقع على الخريطة").',
