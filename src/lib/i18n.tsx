...
export const translations = {
  en: {
    ...
    // Phase 3 — Account Center, Multi-Card & Physical Commerce
    accountCenter: "Account Center",
    accountCenterDesc:
      "Manage your personal profile, subscription tier, card orders, and security settings.",
    tabProfile: "Profile",
    tabPlan: "Plan & Upgrade",
    tabOrders: "Orders",
    ...
    accountEmailNotice:
      "To update your email, a confirmation link will be sent to the new address.",
    accountAvatar: "Account Avatar",
    accountAvatarHint:
      "This avatar represents your account profile and is separate from your digital card avatars.",
    changeAvatar: "Change Avatar",
    profileUpdated: "Profile updated successfully",
    passwordChanged: "Password changed successfully",
    currentPasswordLabel: "Current Password",
    currentPasswordRequired: "Current password is required",
    currentPasswordInvalidError: "The current password you entered is incorrect.",
    newPasswordLabel: "New Password",
    confirmPasswordLabel: "Confirm New Password",
    updatePasswordBtn: "Update Password",
    passwordsDoNotMatch: "Passwords do not match",
    passwordTooShort: "Password must be at least 8 characters",
    deleteAccountTitle: "Delete JustTap Account",
    deleteAccountWarning:
      "Deleting your account is permanent. All digital cards, analytics, and leads will be removed. Physical NFC tags will be safely disconnected. Commerce and order receipts are retained for accounting records.",
    deleteAccountNfcWarning:
      "Warning: Any physical NFC cards linked to your account will become inactive immediately.",
    ...
    cardsCount: "{current} of {max} cards",
    cardLimitReached:
      "Card limit reached for your plan ({max} cards). Upgrade to Pro or Enterprise to add more.",
    trialActiveBanner: "Pro 7-Day Trial Active — {days} days left",
    trialExpiredBanner:
      "Pro Trial Expired — Excess cards are plan-locked. Upgrade to Pro to unlock.",
    planLockedBadge: "Plan Locked",
    planLockedDesc: "This card is preserved safely. Upgrade to Pro to reactivate public sharing.",
    deleteCardTitle: "Delete Digital Card",
    deleteCardNfcWarning:
      "This digital card has a physical NFC card linked to it (Token: {token}). If you delete this card, the NFC tag will become unassigned and stop opening a profile until relinked.",
    deleteCardConfirm: "Are you sure you want to delete '{name}'?",
    cardDeleted: "Card deleted successfully",
    primaryChanged: "Primary card updated",
    recommendedNextStep: "Recommended Next Step",
    recAddCard: "Create your first digital business card to get started.",
    recOrderNfc: "Order your physical Matte NFC card to network seamlessly in person.",
    recShareCard: "Share your primary digital card or add it to Apple Wallet.",

    orderPhysicalCard: "Order Physical NFC Card",
    physicalCardDetails: "Physical Card Details",
    shippingDetails: "Shipping & Delivery Address",
    recipientName: "Recipient Name",
    recipientPhone: "Recipient Phone",
    nationalAddress: "National Address",
    shippingAddress: "National Address",
    shippingCity: "City",
    ...
    taxIncluded: "Tax (0%)",
    orderTotal: "Total (SAR)",
    placeOrder: "Confirm & Place Order",
    orderPlacedSuccess: "Order placed successfully! Order #{orderNumber}",
    ...
    fulfillmentNew: "Order Received",
    fulfillmentPreparing: "Preparing / Encoding NFC",
    fulfillmentReady: "Ready for Dispatch",
    fulfillmentShipped: "Shipped",
    fulfillmentCompleted: "Completed / Delivered",
    fulfillmentCancelled: "Cancelled",
    noOrdersYet: "You haven't ordered any physical cards yet.",
    orderTimeline: "Order Timeline",
    activeOrderNotice: "Physical card order in progress (#{orderNumber})",
    nfcLinkedActive: "Physical NFC Card Active",

    adminTabCardOrders: "Card Orders",
    adminTabNfcCards: "NFC Cards",
    adminOrderNumber: "Order #",
    adminDigitalCardToken: "Digital Card Token",
    adminNfcToken: "NFC Token",
    adminAssignNfcTag: "Assign NFC Tag",
    adminAssignNfcTagPlaceholder: "Select or enter 32-char NFC token",
    adminCompleteOrder: "Complete Order",
    adminCompleteOrderConfirm:
      "Complete Order #{orderNumber}? This verifies physical NFC assignment and finalizes fulfillment.",
    adminFilterPayment: "Payment Filter",
    adminPaidOrdersOnly: "Paid Orders (Actionable)",
    adminPendingCheckouts: "Pending Checkouts",
    adminAllOrders: "All Orders",
    adminCarrier: "Shipping Carrier",
    adminTrackingNumber: "Tracking Number",
    adminCarrierPlaceholder: "e.g. SMSA, Aramex, DHL",
    adminTrackingPlaceholder: "e.g. 123456789",

    // Phase 4: Billing, Subscriptions, Pricing & Commerce
    pricingTitle: "Simple, Transparent Pricing",
    pricingSubtitle:
      "Choose the plan or physical card that fits your professional networking needs.",
    pricingProTitle: "Pro",
    pricingProPrice: "99 SAR",
    pricingProInterval: "/year",
    pricingProDesc: "Everything you need to showcase a standout digital identity.",
    pricingNfcTitle: "JustTap NFC Card",
    pricingNfcPrice: "149 SAR",
    pricingNfcInterval: "one-time",
    pricingNfcDesc: "Premium physical matte NFC card connected to your digital profile.",
    pricingBundleBadge: "Best Value",
    pricingBundleTitle: "Pro + NFC Card Bundle",
    pricingBundlePrice: "199 SAR",
    pricingBundleSave: "Save 49 SAR",
    pricingBundleDesc: "1 year of JustTap Pro plus 1 physical NFC business card.",
    pricingBundleRenewalCopy:
      "Pro renews at 99 SAR/year after the first year. Physical NFC card is included once.",
    pricingFreePrompt: "Not ready for Pro? Start with JustTap Free.",
    pricingFreeLink: "Start Free",
    pricingCtaPro: "Get Pro",
    pricingCtaNfc: "Get the Card",
    pricingCtaBundle: "Get Pro + Card",
    pricingCtaContactSales: "Contact Sales",

    // Account Center Billing
    ...
    planFreeName: "JustTap Free",
    planProName: "JustTap Pro",
    planEnterpriseName: "JustTap Enterprise",
    planRenewalDate: "Renewal Date",
    planNextCharge: "Next charge of {amount} {currency} on {date}",
    annualRenewalOnly: "Billed annually at 99 SAR/year",
    upgradeToProAnnual: "Upgrade to Pro (99 SAR/year)",
    upgradeToBundle: "Upgrade to Pro + NFC Card (199 SAR)",
    orderNfcCardStandalone: "Order NFC Card (149 SAR)",
    providerNotConnectedNotice:
      "Payment processing is currently being prepared. No charges will occur during this preview.",
    bundleCheckoutTitle: "Pro + NFC Card Bundle",
    bundleCheckoutDesc: "Includes 1 year of JustTap Pro and 1 physical Matte NFC Card.",
    bundleInitialPrice: "Initial Purchase: 199 SAR",
    bundleRenewalNotice:
      "Important: Pro will renew at 99 SAR/year after the first year. The physical card is delivered once.",
    statusAwaitingProvider: "Awaiting Payment Provider",
    statusPaid: "Paid",
    ...
    // Admin Billing
    adminTabBilling: "Billing & Commerce",
    adminBillingOverview: "Billing Overview",
    adminTotalPayments: "Total Payment Records",
    adminPaidRevenue: "Paid Revenue",
    adminActiveSubscriptions: "Active Subscriptions",
    adminTrialingSubscriptions: "Trialing Subscriptions",
    adminPastDueSubscriptions: "Past-Due Subscriptions",
    adminReconciliationAlerts: "Reconciliation Alerts",
    adminPaymentsQueue: "Payments Ledger",
    adminSubscriptionsQueue: "Subscriptions Ledger",
    adminReconciliationQueue: "Reconciliation Diagnostics",
    adminPaymentPurpose: "Purpose",
    adminPaymentAmount: "Amount",
    adminPaymentCustomer: "Customer",
    adminPaymentDate: "Date",
    adminPaymentStatus: "Payment Status",
    adminRefundBtn: "Request Refund",
    adminRefundTitle: "Request Payment Refund",
    adminRefundDesc: "Submit a full or partial refund request for this payment.",
    adminRefundAmount: "Refund Amount (SAR)",
    adminRefundReason: "Reason for Refund",
    adminRefundNote: "Internal Admin Note",
    adminRefundRemaining: "Remaining refundable balance: {amount} {currency}",
    adminRefundSubmit: "Submit Refund Request",
    adminRefundSuccess: "Refund request submitted (awaiting provider processing).",
    adminReconciliationHealthy:
      "All internal financial records are consistent. No reconciliation discrepancies found.",
  },
  ar: {
    // Navigation & Common
    appName: "JustTap",
    ...
    accountCenterDesc: "إدارة ملفك الشخصي، باقة الاشتراك، طلبات البطاقات وإعدادات الأمان.",
    tabProfile: "الملف الشخصي",
    tabPlan: "الباقة والترقية",
    tabOrders: "الطلبات",
    tabSecurity: "الأمان",
    ...
    accountEmailNotice: "لتحديث بريدك الإلكتروني، سيتم إرسال رابط تأكيد إلى العنوان الجديد.",
    accountAvatar: "الصورة الشخصية للحساب",
    accountAvatarHint: "هذه الصورة تمثل ملف حسابك وهي منفصلة عن صور بطاقاتك الرقمية.",
    changeAvatar: "تغيير الصورة",
    profileUpdated: "تم تحديث الملف الشخصي بنجاح",
    passwordChanged: "تم تغيير كلمة المرور بنجاح",
    currentPasswordLabel: "كلمة المرور الحالية",
    currentPasswordRequired: "يرجى إدخال كلمة المرور الحالية",
    currentPasswordInvalidError: "كلمة المرور الحالية التي أدخلتها غير صحيحة",
    newPasswordLabel: "كلمة المرور الجديدة",
    confirmPasswordLabel: "تأكيد كلمة المرور الجديدة",
    updatePasswordBtn: "تحديث كلمة المرور",
    passwordsDoNotMatch: "كلمات المرور غير متطابقة",
    passwordTooShort: "يجب ألا تقل كلمة المرور عن 8 أحرف",
    deleteAccountTitle: "حذف حساب JustTap",
    deleteAccountWarning:
      "حذف حسابك إجراء نهائي. سيتم حذف جميع البطاقات الرقمية والإحصائيات وجهات الاتصال. سيتم إلغاء ربط بطاقات NFC الذكية بأمان، مع الاحتفاظ بسجلات الفواتير والطلبات للأغراض المحاسبية.",
    deleteAccountNfcWarning: "تحذير: أي بطاقات NFC فيزيائية مرتبطة بحسابك ستصبح غير مفعلة فوراً.",
    typeDeleteToConfirm: "اكتب DELETE للتأكيد:",
    deleteMyAccount: "حذف الحساب نهائياً",
    accountDeletedSuccess: "تم حذف الحساب بنجاح",

    primaryCard: "البطاقة الرئيسية",
    setAsPrimary: "تعيين كبطاقة رئيسية",
    cardLimit: "حد البطاقات",
    cardsCount: "{current} من {max} بطاقات",
    cardLimitReached:
      "تم الوصول للحد الأقصى للبطاقات في باقتك ({max} بطاقات). قم بالترقية إلى Pro أو Enterprise لإضافة المزيد.",
    trialActiveBanner: "تجربة Pro لمدة 7 أيام نشطة — متبقي {days} أيام",
    trialExpiredBanner: "انتهت تجربة Pro — تم قفل البطاقات الإضافية. قم بالترقية إلى Pro لفتحها.",
    planLockedBadge: "مقفلة في الباقة",
    planLockedDesc: "هذه البطاقة محفوظة بأمان. قم بالترقية إلى Pro لإعادة تفعيل المشاركة العامة.",
    deleteCardTitle: "حذف البطاقة الرقمية",
    deleteCardNfcWarning:
      "هذه البطاقة الرقمية مرتبطة ببطاقة NFC ذكية (الرمز: {token}). إذا قمت بحذفها، ستصبح بطاقة NFC غير معينة ولن تفتح أي ملف شخصي حتى تتم إعادة ربطها.",
    deleteCardConfirm: "هل أنت متأكد من رغبتك في حذف '{name}'؟",
    cardDeleted: "تم حذف البطاقة بنجاح",
    primaryChanged: "تم تحديث البطاقة الرئيسية",
    recommendedNextStep: "الخطوة التالية المقترحة",
    recAddCard: "أنشئ بطاقتك الرقمية الأولى للبدء.",
    recOrderNfc: "اطلب بطاقتك الذكية NFC للتواصل بلمسة واحدة في الفعاليات واللقاءات.",
    recShareCard: "شارك بطاقتك الرقمية الرئيسية أو أضفها إلى Apple Wallet.",

    orderPhysicalCard: "طلب بطاقة NFC ذكية",
    physicalCardDetails: "تفاصيل البطاقة الذكية",
    shippingDetails: "بيانات الشحن والتوصيل",
    recipientName: "اسم المستلم",
    recipientPhone: "رقم هاتف المستلم",
    nationalAddress: "العنوان الوطني",
    shippingAddress: "العنوان الوطني",
    shippingCity: "المدينة",
    postalCode: "الرمز البريدي (اختياري)",
    deliveryInstructions: "تعليمات التوصيل (اختياري)",
    orderSummary: "ملخص الطلب",
    productPrice: "سعر البطاقة",
    shippingFee: "الشحن",
    freeShipping: "شحن مجاني",
    taxIncluded: "الضريبة (0%)",
    orderTotal: "المجموع (ر.س)",
    placeOrder: "تأكيد وإتمام الطلب",
    orderPlacedSuccess: "تم تقديم الطلب بنجاح! رقم الطلب #{orderNumber}",
    orderStatus: "حالة الطلب",
    paymentStatus: "حالة الدفع",
    fulfillmentStatus: "حالة التجهيز والشحن",
    paymentPending: "في انتظار الدفع",
    paymentPaid: "مدفوع",
    paymentFailed: "فشل الدفع",
    paymentRefunded: "مسترجع",
    fulfillmentNew: "تم استلام الطلب",
    fulfillmentPreparing: "جاري التجهيز والبرمجة",
    fulfillmentReady: "جاهز للإرسال",
    fulfillmentShipped: "تم الشحن",
    fulfillmentCompleted: "مكتمل / تم التسليم",
    fulfillmentCancelled: "ملغي",
    noOrdersYet: "لم تقم بطلب أي بطاقات فيزيائية حتى الآن.",
    orderTimeline: "مراحل الطلب",
    activeOrderNotice: "طلب البطاقة الذكية قيد التنفيذ (#{orderNumber})",
    nfcLinkedActive: "بطاقة NFC الذكية مفعلة ومرتبطة",

    adminTabCardOrders: "طلبات البطاقات",
    adminTabNfcCards: "بطاقات NFC",
    adminOrderNumber: "رقم الطلب",
    adminDigitalCardToken: "رمز البطاقة الرقمية",
    adminNfcToken: "رمز NFC",
    adminAssignNfcTag: "تعيين شريحة NFC",
    adminAssignNfcTagPlaceholder: "اختر أو أدخل رمز NFC المكون من 32 حرفاً",
    adminCompleteOrder: "إكمال الطلب",
    adminCompleteOrderConfirm:
      "إكمال الطلب #{orderNumber}؟ هذا يؤكد تعيين شريحة NFC وينهي عملية التجهيز.",
    adminFilterPayment: "تصفية الدفع",
    adminPaidOrdersOnly: "الطلبات المدفوعة (قابلة للتنفيذ)",
    adminPendingCheckouts: "محاولات الشراء المعلقة",
    adminAllOrders: "جميع الطلبات",
    adminCarrier: "شركة الشحن",
    adminTrackingNumber: "رقم التتبع",
    adminCarrierPlaceholder: "مثال: سمسا، أرامكس، DHL",
    adminTrackingPlaceholder: "مثال: 123456789",

    // Phase 4: Billing, Subscriptions, Pricing & Commerce
    pricingTitle: "باقات واضحة ومرنة",
    pricingSubtitle: "اختر الباقة أو البطاقة الذكية التي تناسب تواصلك المهني وأعمالك.",
    pricingProTitle: "برو (Pro)",
    pricingProPrice: "99 ر.س",
    pricingProInterval: "/سنوياً",
    pricingProDesc: "كل ما تحتاجه لإبراز هويتك المهنية وتوسيع شبكة علاقاتك.",
    pricingNfcTitle: "بطاقة JustTap الذكية (NFC)",
    pricingNfcPrice: "149 ر.س",
    pricingNfcInterval: "تدفع لمرة واحدة",
    pricingNfcDesc: "بطاقة فيزيائية مطفية فاخرة مع شريحة NFC متصلة بملفك الرقمي.",
    pricingBundleBadge: "القيمة الأفضل",
    pricingBundleTitle: "باقة برو + بطاقة NFC الذكية",
    pricingBundlePrice: "199 ر.س",
    pricingBundleSave: "وفر 49 ر.س",
    pricingBundleDesc: "سنة كاملة من JustTap Pro بالإضافة إلى بطاقة NFC ذكية مطفية فاخرة.",
    pricingBundleRenewalCopy:
      "تجدد باقة Pro بسعر 99 ر.س/سنوياً بعد السنة الأولى. البطاقة الذكية مشمولة لمرة واحدة فقط.",
    pricingFreePrompt: "لست جاهزاً لـ Pro بعد؟ ابدأ مع JustTap مجاناً.",
    pricingFreeLink: "ابدأ مجاناً",
    pricingCtaPro: "اشترك في Pro",
    pricingCtaNfc: "اطلب البطاقة",
    pricingCtaBundle: "احصل على Pro + البطاقة",
    pricingCtaContactSales: "تواصل مع المبيعات",

    // Account Center Billing
    tabBilling: "الاشتراك والفوترة",
    subscriptionStatus: "حالة الاشتراك",
    billingHistory: "سجل العمليات والفواتير",
    noBillingHistory: "لا يوجد سجل فواتير حتى الآن.",
    paymentMethods: "وسائل الدفع",
    noPaymentMethods: "لا توجد وسيلة دفع محفوظة.",
    currentPlan: "الباقة الحالية",
    planFreeName: "JustTap مجاني",
    planProName: "JustTap برو",
    planEnterpriseName: "JustTap للمؤسسات",
    planRenewalDate: "تاريخ التجديد",
    planNextCharge: "التجديد القادم بمبلغ {amount} {currency} في {date}",
    annualRenewalOnly: "تجديد سنوي بقيمة 99 ر.س/سنوياً",
    upgradeToProAnnual: "الترقية إلى Pro (99 ر.س/سنوياً)",
    upgradeToBundle: "الترقية إلى Pro + بطاقة NFC (199 ر.س)",
    orderNfcCardStandalone: "طلب بطاقة NFC فقط (149 ر.س)",
    providerNotConnectedNotice:
      "نظام معالجة المدفوعات قيد الإعداد التقني. لن يتم خصم أي مبالغ في هذه المرحلة.",
    bundleCheckoutTitle: "باقة برو + بطاقة NFC الذكية",
    bundleCheckoutDesc: "تتضمن اشتراك Pro لمدة سنة وبطاقة JustTap مطفية فاخرة.",
    bundleInitialPrice: "الشراء الأولي: 199 ر.س",
    bundleRenewalNotice:
      "تنبيه هام: يتجدد اشتراك Pro بقيمة 99 ر.س/سنوياً بعد السنة الأولى. يتم تسليم البطاقة الفيزيائية مرة واحدة فقط.",
    statusAwaitingProvider: "في انتظار بوابة الدفع",
    statusPaid: "مدفوع",
    statusRefunded: "مسترجع",
    statusPartiallyRefunded: "مسترجع جزئياً",
    statusFailed: "فشل",
    statusPending: "قيد الانتظار",

    // Admin Billing
    adminTabBilling: "الفوترة والتجارة",
    adminBillingOverview: "نظرة عامة على الفوترة",
    adminTotalPayments: "إجمالي سجلات الدفع",
    adminPaidRevenue: "الإيرادات المدفوعة",
    adminActiveSubscriptions: "الاشتراكات النشطة",
    adminTrialingSubscriptions: "الاشتراكات التجريبية",
    adminPastDueSubscriptions: "الاشتراكات المتأخرة",
    adminReconciliationAlerts: "تنبيهات المطابقة",
    adminPaymentsQueue: "سجل المدفوعات",
    adminSubscriptionsQueue: "سجل الاشتراكات",
    adminReconciliationQueue: "تشخيص المطابقة",
    adminPaymentPurpose: "الغرض",
    adminPaymentAmount: "المبلغ",
    adminPaymentCustomer: "العميل",
    adminPaymentDate: "التاريخ",
    adminPaymentStatus: "حالة الدفع",
    adminRefundBtn: "طلب استرجاع",
    adminRefundTitle: "طلب استرجاع مبلغ",
    adminRefundDesc: "تقديم طلب استرجاع كلي أو جزئي لهذه العملية.",
    adminRefundAmount: "مبلغ الاسترجاع (ر.س)",
    adminRefundReason: "سبب الاسترجاع",
    adminRefundNote: "ملاحظات الإدارة الداخلية",
    adminRefundRemaining: "الرصيد المتبقي القابل للاسترجاع: {amount} {currency}",
    adminRefundSubmit: "إرسال طلب الاسترجاع",
    adminRefundSuccess: "تم تقديم طلب الاسترجاع (في انتظار معالجة بوابة الدفع).",
    adminReconciliationHealthy: "جميع السجلات المالية الداخلية متطابقة وسليمة. لا توجد أي تعارضات.",
  },
};
